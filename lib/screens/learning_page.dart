...
import 'practical_page.dart'; // Import the PracticalPage
                ...
                children: <Widget>[
                  ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => const TheoreticalPage()), // Navigate to TheoreticalPage
                      );
                    },
                    child: Padding(
                  ...
                  ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => PracticalPage()), // Navigate to PracticalPage
                      );
                    },
                    child: Padding(
                      padding: const EdgeInsets.all(16.0),

        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              image: DecorationImage(
                image: AssetImage('images/image.png'), // Path to your background image
                fit: BoxFit.cover,
              ),
            ),
          ),
          ...
          Center(
            child: Column(
              ...
              children: <Widget>[
                SizedBox(height: 10), // Add space between the app bar and the text
                Text(
                  'Select an option',
                  style: TextStyle(
                    fontSize: 45, // Match the font size with main.dart
                    fontWeight: FontWeight.bold,
                    color: Colors.black, // Text color changed to white for better visibility
                    shadows: [
                      Shadow(
                        blurRadius: 1.0,
                        color: Colors.black,
                ...
                SizedBox(height: 40), // Add space between the text and the buttons
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: <Widget>[
                    ElevatedButton(
                      ...
                      child: Padding(
                        padding: const EdgeInsets.all(16.0), // Increase padding to make button bigger
                        child: Text(
                          'Learning',
                          style: TextStyle(fontSize: 30, fontWeight: FontWeight.bold), // Adjust text size to match main.dart
                        ),
                      ),
